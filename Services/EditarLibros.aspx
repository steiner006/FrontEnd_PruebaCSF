<%@ Page Async="true" Language="C#" AutoEventWireup="true" CodeBehind="EditarLibros.aspx.cs" Inherits="PruebaCSF_FrontEnd.Services.EditarLibros" %>
...
<body>
    <form id="formEditAuthor" runat="server" class="container">
        <div class="container mt-5">
            ...
            <div class="mb-3">
                <label for="lblAutores" class="form-label">Autores</label>
                <asp:TextBox ID="txtAutores" runat="server" CssClass="form-control"></asp:TextBox>
            </div>
            <div class="mb-3">
                <label for="txtFecha" class="form-label">Año de Publicación</label>
