    ...
    <form id="form1" runat="server">
        <div class="container mt-5">
            ...
            <asp:GridView ID="gvLibros" runat="server" CssClass="table table-bordered table-striped"
                AutoGenerateColumns="False" EmptyDataText="Libros no encontrados" OnRowDataBound="gvLibros_RowDataBound">
                <Columns>
                    ...
                    <asp:BoundField DataField="AnioPublicacion" HeaderText="Año de Publicación" SortExpression="AnioPublicacion" DataFormatString="{0:yyyy}" SortDirection="Ascending" />
